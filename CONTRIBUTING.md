# Contributing to pointidentity

We would love for you to contribute to pointidentity and help make it even better than it is today!
As a contributor, here are the guidelines we would like you to follow.

## 🧑‍⚖️ Code of Conduct

Help us keep pointidentity open and inclusive.
...
3. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the [pointidentity-node](https://github.com/pointidentity/pointidentity-node) repository.
...
9. In GitHub, send a pull request to `pointidentity-node:main`.
