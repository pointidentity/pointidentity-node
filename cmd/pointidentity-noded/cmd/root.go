...
import (
	...
	appparams "github.com/pointidentity/pointidentity-node/app/params"
...
var ChainID = "pointidentity-mainnet-1"
...
func queryCommand() *cobra.Command {
	...
	cmd.PersistentFlags().String(flags.FlagChainID, "pointidentity-mainnet-1", "The network chain ID")
...
func txCommand() *cobra.Command {
	...
	cmd.PersistentFlags().String(flags.FlagChainID, "pointidentity-mainnet-1", "The network chain ID")
	cmd.PersistentFlags().String(flags.FlagGasPrices, "50upoint", "Gas prices in decimal format")
