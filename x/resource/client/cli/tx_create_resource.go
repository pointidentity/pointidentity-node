...
Example payload file:
{
    "payload": {
        ...
        "alsoKnownAs": [
            {
                "uri": "did:pointid:<namespace>:<unique-identifier>/resource/<uuid>",
                "description": "did-url"
            },
            {
...
`,
	...
	cmd.Flags().String(flags.FlagFees, sdk.NewCoin(types.BaseMinimalDenom, sdk.NewInt(types.DefaultCreateResourceImageFee)).String(), "Fixed fee for Resource creation, e.g., 10000000000upoint. Please check what the current fees by running 'pointidentity-noded query params subspace resource feeparams'")
