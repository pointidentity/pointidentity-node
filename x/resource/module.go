...
import (
	...
	"github.com/pointidentity/pointidentity-node/x/resource/client/cli"
	migrationV3 "github.com/pointidentity/pointidentity-node/x/resource/migration/v3"
...
func NewAppModule(cdc codec.Codec, keeper keeper.Keeper, pidKeeper didkeeper.Keeper) AppModule {
	return AppModule{
