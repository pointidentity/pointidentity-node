	...
	Entry("all fields",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				...
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "4000000000"}, "default": {"denom": "upoint", "amount": "2000000000"}, "burn_factor": "0.600000000000000000"}`,
			}),
	...
	Entry("omit fields",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "4000000000"}, "burn_factor": "0.600000000000000000"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
	...
	Entry("invalid value: case `image` amount 0",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "0"}, "json": {"denom": "upoint", "amount": "4000000000"}, "default": {"denom": "upoint", "amount": "2000000000"}, "burn_factor": "0.600000000000000000"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
	...
	Entry("invalid value: case `json` amount 0",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "0"}, "default": {"denom": "upoint", "amount": "2000000000"}, "burn_factor": "0.600000000000000000"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
	...
	Entry("invalid value: case `default` amount 0",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "4000000000"}, "default": {"denom": "upoint", "amount": "0"}, "burn_factor": "0.600000000000000000"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
	...
	Entry("invalid value: case `burn_factor` -1",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "4000000000"}, "default": {"denom": "upoint", "amount": "2000000000"}, "burn_factor": "-1"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
	...
	Entry("invalid value: case `burn_factor` 1.1",
		TestCaseKeeperProposal{
			testProposal(proposal.ParamChange{
				Subspace: resourcetypes.ModuleName,
				Key:      string(resourcetypes.ParamStoreKeyFeeParams),
				Value:    `{"image": {"denom": "upoint", "amount": "10000000000"}, "json": {"denom": "upoint", "amount": "4000000000"}, "default": {"denom": "upoint", "amount": "2000000000"}, "burn_factor": "1.1"}`,
			}),
			func(*HandlerTestSuite) {},
			true,
			"",
