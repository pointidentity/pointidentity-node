...
// DefaultFeeParams returns default pointidentity module tx fee parameters
...
// ValidateBasic performs basic validation of pointidentity module tx fee parameters
