...
import (
	...
	. "github.com/pointid/pointid-node/x/did/types"
)
			...
			TestCaseMsgCreateDID{
				msg: &MsgCreateDidDoc{
					Payload: &MsgCreateDidDocPayload{
						Id: "did:pointid:testnet:zABCDEFG123456789abcd",
						VerificationMethod: []*VerificationMethod{
							{
								Id:                     "did:pointid:testnet:zABCDEFG123456789abcd#key1",
								VerificationMethodType: "Ed25519VerificationKey2020",
								Controller:             "did:pointid:testnet:zABCDEFG123456789abcd",
								VerificationMaterial:   ValidEd25519VerificationKey2020VerificationMaterial,
							},
						},
						Authentication: []string{"did:pointid:testnet:zABCDEFG123456789abcd#key1", "did:pointid:testnet:zABCDEFG123456789abcd#aaa"},
			...
			TestCaseMsgCreateDID{
				msg: &MsgCreateDidDoc{
					Payload: &MsgCreateDidDocPayload{
						...
						Authentication: []string{"did:pointid:testnet:zABCDEFG123456789abcd#key1", "did:pointid:testnet:zABCDEFG123456789abcd#key1"},
					},
					Signatures: nil,
				},
				isValid:  false,
