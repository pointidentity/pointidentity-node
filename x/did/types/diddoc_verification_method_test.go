...
var _ = DescribeTable("Verification Method validation tests", func(testCase VerificationMethodTestCase) {
	...
	Entry(
		...
		VerificationMethodTestCase{
			vm: didtypes.VerificationMethod{
				Id:                     "did:pointid:zABCDEFG123456789abcd#qwe",
				VerificationMethodType: "Ed25519VerificationKey2020",
				Controller:             "did:pointid:zABCDEFG987654321abcd",
	...
	Entry(
		...
		VerificationMethodTestCase{
			vm: didtypes.VerificationMethod{
				Id:                     "did:pointid:zABCDEFG123456789abcd#rty",
	...
	Entry(
		...
		VerificationMethodTestCase{
			vm: didtypes.VerificationMethod{
				Id:                     "did:pointid:zABCDEFG123456789abcd#uio",
	...
	Entry(
		...
		VerificationMethodTestCase{
			...
			baseDid:  "did:pointid:zABCDEFG123456789abcd",
			isValid:  true,
			errorMsg: "",
		},
	),
	...
	Entry(
		...
		VerificationMethodTestCase{
			vm: didtypes.VerificationMethod{
				Id:                     "did:pointid:mainnet:zABCDEFG123456789abcd#rty",
				VerificationMethodType: "JsonWebKey2020",
				Controller:             "did:pointid:zABCDEFG987654321abcd",
				VerificationMaterial:   ValidJWK2020VerificationMaterial,
			},
