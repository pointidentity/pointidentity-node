...
func Setup() TestSetup {
	...
	accountKeeper := authkeeper.NewAccountKeeper(Cdc, keys[authtypes.StoreKey], authtypes.ProtoBaseAccount, maccPerms, "pointidentity", authtypes.NewModuleAddress(govtypes.ModuleName).String())
