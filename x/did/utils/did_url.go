...
// SplitDIDURLRegexp ...
// That for groups:
// Example: did:pointid:testnet:fafdsffq11213343/path-to-s/ome-external-resource?query#key1???
// 1 - [^/?#]* - all the symbols except / and ? and # . This is the DID part                      (did:pointid:testnet:fafdsffq11213343)
