...
func AddTxFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(flags.FlagGasPrices, "", "Gas prices in decimal format to determine the transaction fee (e.g. 50upoint)")
	cmd.Flags().String(flags.FlagNode, "tcp://localhost:26647", "<host>:<port> to tendermint rpc interface for this chain")
