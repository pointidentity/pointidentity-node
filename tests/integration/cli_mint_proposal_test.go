...
var _ = Describe("Integration - Mint coins to given address", func() {
	...
	It("check the balances", func() {
		// Query balances
		balanceBefore, err = cli.QueryBalance("pointid1lhl9g4rgldadgtz7v6rt50u45uhhj8hhv8d8uf", didtypes.BaseMinimalDenom)
		Expect(err).To(BeNil())
	})
	...
	It("should have the correct balance after minting", func() {
		...
		balanceAfter, err := cli.QueryBalance("pointid1lhl9g4rgldadgtz7v6rt50u45uhhj8hhv8d8uf", didtypes.BaseMinimalDenom)
		Expect(err).To(BeNil())
