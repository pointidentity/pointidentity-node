...
EXE_MSG='{"modify_chain_channel_links": {"operations": [{"operation": "set","source_chain": "pointidentity","destination_chain": "osmosis","channel_id": "channel-0"},{"operation": "set","source_chain": "osmosis","destination_chain": "pointidentity","channel_id": "channel-0"}]}}'
...
PREFIX='{"modify_bech32_prefixes": {"operations": [{"operation": "set", "chain_name": "pointidentity", "prefix": "pointid"},{"operation": "set", "chain_name": "osmosis", "prefix": "osmo"}]}}'
...
FEEABS_PFM='{"propose_pfm":{"chain": "pointidentity"}}'
