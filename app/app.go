...
import (
	...
	upgradeV2 "github.com/pointidentity/pointidentity-node/app/upgrades/v2"
	posthandler "github.com/pointidentity/pointidentity-node/post"
	did "github.com/pointidentity/pointidentity-node/x/did"
	...
	resourcekeeper "github.com/pointidentity/pointidentity-node/x/resource/keeper"
	...
	_ "github.com/pointidentity/pointidentity-node/app/client/docs/statik"
	upgradeV3 "github.com/pointidentity/pointidentity-node/app/upgrades/v3"
)
...
func New(
	...
	app.FeeMarketKeeper = feemarketkeeper.NewKeeper(appCodec, keys[feemarkettypes.StoreKey], app.AccountKeeper, &pidante.DenomResolverImpl{}, authtypes.NewModuleAddress(govtypes.ModuleName).String())
	...
	app.FeeMarketKeeper.SetDenomResolver(&pidante.DenomResolverImpl{
