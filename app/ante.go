...
// Here we add the pointidentity ante decorators, which extend default SDK AnteHandler.
type HandlerOptions struct {
	AccountKeeper          pidante.AccountKeeper
	BankKeeper             pidante.BankKeeper
	...
	DidKeeper              pidante.DidKeeper
	ResourceKeeper         pidante.ResourceKeeper
...
func NewAnteHandler(options HandlerOptions) (sdk.AnteHandler, error) {
	...
	anteDecorators := []sdk.AnteDecorator{
		...
		pidante.NewOverAllDecorator( // fee market check replaces fee deduct decorator
